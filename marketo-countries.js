...
(function ($) {
  ...
  ulmkto.get_optin_js = function() {
    ...
    if (optinfile == null || !optinfile.includes('.js')) {
      ...
      optinfile = '/wp-content/plugins/ul_shortcodes/js/gdpr-default.js'
    }
